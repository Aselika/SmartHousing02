    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CameraSettings", x => x.CameraId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportsScheduling = table.Column<bool>(type: "bit", nullable: false),
                    CommandOn = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CommandOff = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
